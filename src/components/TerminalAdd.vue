    ...
    <div class="message">
      ...
      <el-form :inline="true">
        <el-form-item label="归属商户" label-width="150px">
          <GetCompany :data="company1" :holder="'请输入归属商户'"></GetCompany>
          <!--<el-input size="small" v-model="messageForm.merchantName"></el-input>-->
        </el-form-item>
        <el-form-item label="归属商户编号" label-width="150px">
          <el-input size="small" v-model="messageForm.merchantNo"></el-input>
        </el-form-item>
        ...
        <el-form-item label="归属地区" label-width="150px">
          <div class="area">
            <Province :propdata="messageForm"></Province>
          </div>
        </el-form-item>
      ...
      <div class="button">
        <el-button class="clear" size="small">清空</el-button>
          ...
          <el-table-column type="expand">
            <template slot-scope="props">
              <el-form label-position="left" :inline="true" class="demo-table-expand">
                ...
                <el-form-item label="归属地区" label-width="100px">
                  <span>
                ...
                <el-form-item label="归属商户编号" label-width="100px">
