      ...
      <el-row :gutter="20">
        ...
        <el-col :span="6">
          <div class="girid-content girid-ipt">
            ...
            <!--<el-option v-for="item in collaborData" :value="item.value" :label="item.label"></el-option>-->
            <!--</el-select>-->
          </div>
        </el-col>
      </el-row>
    ...
    <div class="upload">
      ...
      <el-row :gutter="20">
        <el-col :span="2" :offset="20">
          <button type="button" class="grid-content upload-btn" @click="addMerchant">修改商户</button>
        </el-col>
      </el-row>
    </div>
    <div class="showImg">
