<template>
  <div id="News">
    <div class="search">
      ...
      >
        <el-form-item>
          <el-input size="small" v-model="formSearch.title" placeholder="请输入标题信息"></el-input>
        </el-form-item>
        <el-form-item>
    ...
    <!--新增按钮-->
    <div class="addNews">
      <el-button type="primary" @click="$router.push('/newsadd')"><i class="el-icon-plus"></i>新增</el-button>
    </div>
    <!--表格-->
    <div class="table-warp">
      ...
      >
        ...
        <el-table-column align="center" label="标题" prop="title" min-width="100"></el-table-column>
        <el-table-column align="center" label="图片" prop="" min-width="100">
          <template slot-scope="scope">
            <img :src="scope.row.thumbImage" class="image" alt="">
          </template>
        </el-table-column>
        <el-table-column align="center" label="排序" prop="index" min-width="100"></el-table-column>
        <el-table-column align="center" label="状态" prop="enableFlag" min-width="100"></el-table-column>
        <el-table-column align="center" label="创建时间" prop="sfsCreate" min-width="100"></el-table-column>
        <el-table-column align="center" label="发布时间" prop="openDate" min-width="100"></el-table-column>
        <el-table-column align="center" label="置顶" prop="up" min-width="100"></el-table-column>
